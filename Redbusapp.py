...
# Define the base file path for your CSV files
base_path = "C:/Users/Ramanathan/Desktop/Capstone project/"  

# Kerala bus data
lists_k = []
try:
    df_k = pd.read_csv(base_path + "df_k.csv")
    for i, r in df_k.iterrows():
        lists_k.append(r["Route_name"])
except FileNotFoundError:
    print("File 'df_k.csv' not found. Please check the path.")

# Andhra bus data
lists_A = []
try:
    df_A = pd.read_csv(base_path + "df_A.csv")
    for i, r in df_A.iterrows():
        lists_A.append(r["Route_name"])
except FileNotFoundError:
    print("File 'df_A.csv' not found. Please check the path.")

# Telangana bus data
lists_T = []
try:
    df_T = pd.read_csv(base_path + "df_T.csv")
    for i, r in df_T.iterrows():
        lists_T.append(r["Route_name"])
except FileNotFoundError:
    print("File 'df_T.csv' not found. Please check the path.")

#Goa bus
lists_G = []
try:
    df_G = pd.read_csv(base_path + "df_G.csv")
    for i, r in df_G.iterrows():
        lists_G.append(r["Route_name"])
except FileNotFoundError:
    print("File 'df_G.csv' not found. Please check the path.")

# Rajasthan bus data
lists_R = []
try:
    df_R = pd.read_csv(base_path + "df_R.csv")
    for i, r in df_R.iterrows():
        lists_R.append(r["Route_name"])
except FileNotFoundError:
    print("File 'df_R.csv' not found. Please check the path.")

# South bengal bus 
    lists_SB = []
try:
    df_SB = pd.read_csv(base_path + "df_SB.csv")
    for i, r in df_SB.iterrows():
        lists_SB.append(r["Route_name"])
except FileNotFoundError:
    print("File 'df_SB.csv' not found. Please check the path.")

# Haryana bus data
lists_H = []
try:
    df_H = pd.read_csv(base_path + "df_H.csv")
    for i, r in df_H.iterrows():
        lists_H.append(r["Route_name"])
except FileNotFoundError:
    print("File 'df_H.csv' not found. Please check the path.")

# Assam bus data
lists_AS = []
try:
    df_AS = pd.read_csv(base_path + "df_AS.csv")
    for i, r in df_AS.iterrows():
        lists_AS.append(r["Route_name"])
except FileNotFoundError:
    print("File 'df_AS.csv' not found. Please check the path.")

# Uttar Pradesh bus data
lists_UP = []
try:
    df_UP = pd.read_csv(base_path + "df_UP.csv")
    for i, r in df_UP.iterrows():
        lists_UP.append(r["Route_name"])
except FileNotFoundError:
    print("File 'df_UP.csv' not found. Please check the path.")

# West Bengal bus data
lists_WB = []
try:
    df_WB = pd.read_csv(base_path + "df_WB.csv")
    for i, r in df_WB.iterrows():
        lists_WB.append(r["Route_name"])
except FileNotFoundError:
    print("File 'df_WB.csv' not found. Please check the path.")
...
if web=="Home":
    ...
    slt.subheader(":blue[Developed-by:]  Sweatha")
...
if web == "📍States and Routes":
    ...
    if S == "Kerala":
        ...
        def type_and_fare(bus_type, fare_range):
            conn = mysql.connector.connect(host="127.0.0.1", user="root", password="Swaminathan@2024", database="RED_BUS_DETAILS")
